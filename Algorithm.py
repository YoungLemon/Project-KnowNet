...
def pagerank(N, alpha=0.85, personalization=None, max_iter=100, tol=1e-06, nstart=None, weight='weight', dangling=None):
    """对网络进行PageRank计算，返回一个dict，键为node，值为pagerank值"""
    return nx.pagerank(N.network, alpha, personalization, max_iter, tol, nstart, weight, dangling)
...
if __name__ == "__main__":
    ...
    import community
    # 下面是支持的参数列表
    # files = ["JOI.txt", "JASIST.txt"]
    # topic_types = ["LSA", "LDA"]
    # fields1 = ["keyword", "title", "abstract"]
    # fields2 = ["title", "abstract"]
    # # centrality_types = ['degree', 'eigenvector', 'betweenness']
    # centrality_types = ['degree', 'eigenvector']
    # 分析JOI的主题
    # data = wos_process.wos2paper("JOI.txt", include_review=False)
    # for topic_type in topic_types:
    #     for field in fields1:
    #         for centrality_type in centrality_types:
    #             analysis_topic_by_time(data, topic_type=topic_type, field=field, centrality_type=centrality_type,
    #                                    cumulative=True, num_topics=9, num_words=10)
    #             print("JOI.txt", topic_type, field, centrality_type, "完成")
    # 分析JASIST的主题
    # data = wos_process.wos2paper("JASIST.txt", include_review=False)
    # for topic_type in topic_types:
    #     for field in fields2:
    #         for centrality_type in centrality_types:
    #             analysis_topic_by_time(data, topic_type=topic_type, field=field, centrality_type=centrality_type,
    #                                    cumulative=True, num_topics=9, num_words=10)
    #             print("JASIST.txt", topic_type, field, centrality_type, "完成")
